...
/**
 * Panel for PngAgnosticFileBlobStoreInfo, identical to panel for FileBlobStore
 *
 * @author Niels Charlier
 */
public class PngAgnosticFileBlobStorePanel extends Panel {

    private static final long serialVersionUID = -8237328668463257329L;

    public PngAgnosticFileBlobStorePanel(String id, final IModel<PngAgnosticFileBlobStoreInfo> configModel) {
