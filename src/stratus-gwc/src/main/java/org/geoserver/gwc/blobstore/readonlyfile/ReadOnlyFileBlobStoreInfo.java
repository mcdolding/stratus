 ...
 * @author mike.dolding
 */
public class ReadOnlyFileBlobStoreInfo extends BlobStoreInfo  {

    private static final long serialVersionUID = 87243591561561659L;

    private String baseDirectory;

    public ReadOnlyFileBlobStoreInfo() {
        super();
    }

    public ReadOnlyFileBlobStoreInfo(String id) {
        super(id);
    }
    ...
    public String toString() {
        return new StringBuilder("ReadOnlyFileBlobStore[id:")
                .append(getName())
                .append(", enabled:")
                .append(isEnabled())
    ...
    public BlobStore createInstance(TileLayerDispatcher layers, LockProvider lockProvider)
        ...
        checkState(
                isEnabled(),
                "Can't call ReadOnlyFileBlobStoreConfig.createInstance() is blob store is not enabled");
        checkState(baseDirectory != null, "baseDirectory not provided");
        ReadOnlyFileBlobStore fileBlobStore = new ReadOnlyFileBlobStore(baseDirectory);
